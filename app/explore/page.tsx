...
const featured = () => {
  return (
    <div className=" mt-8">
      <h1 className="md:text-[76px] text-[46px] md:pl-40 md:pr-40 pl-10 pr-10">
        <b> Hey!, This is Suhas.</b> Discover my stories and ideas here.
      </h1>
      <div className="mt-30 xl:flex items:center gap-[50px] md:pl-40 md:pr-40 pl-10 pr-10">
        <div className="flex-1 h-[350px] relative ">
          <Image src="/wah.jpg" alt="" fill className="object-cover rounded-lg" />
        </div>
